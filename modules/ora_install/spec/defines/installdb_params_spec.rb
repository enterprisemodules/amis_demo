...
describe 'ora_install::installdb', :type => :define do
  ...
  describe "wrong db version" do
    ...
    it do
      expect { should contain_notify("ora_install::installdb /oracle/product/10.2/db does not exists")
  ...
  describe "wrong O.S." do
    ...
    it do
      expect { should contain_notify("ora_install::installdb /oracle/product/11.2/db does not exists")
