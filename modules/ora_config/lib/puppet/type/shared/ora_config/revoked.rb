newproperty(:revoked, :array_matching => :all) do
  include EasyType
  ...
  validate do |value|
    fail 'property grants and property revoked are mutualy exclusive. You can only use one of them.' if resource.grants && resource.grants.any?
